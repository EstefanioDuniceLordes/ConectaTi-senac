    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/chamados/*/status", "/chamados/*/assumir", "/chamados/*/relatorio-tecnico").hasAnyRole("TECNICO", "ADMINISTRADOR")
                        .requestMatchers("/chamados/**").hasAnyRole("ADMINISTRADOR", "INSTRUTOR", "COORDENADOR", "TECNICO")
                        .requestMatchers(HttpMethod.GET, "/equipamentos/**", "/categorias/**", "/salas/**", "/laboratorios/**").authenticated()
                        .requestMatchers("/equipamentos/**", "/categorias/**", "/salas/**", "/laboratorios/**").hasRole("ADMINISTRADOR")
